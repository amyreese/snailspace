...
plat1.position = Vector2( ( 0+platOffX ) * 64, 5 * 64 )
plat1.layer = 0.5
...
plat2.position = Vector2( (15+platOffX) * 64, -4.5 * 64 )
plat2.layer = 0.5
...
plat3.position = Vector2( (40+platOffX)*64, -15 * 64 )
plat3.layer = 0.5
...
plat4.position = Vector2( (65+platOffX)*64, -8 * 64 )
plat4.layer = 0.5
...
plat5.position = Vector2( (20+platOffX)*64, 15*64 )
plat5.layer = 0.5
...
plat6.position = Vector2( (45+platOffX)*64, 10*64 )
plat6.layer = 0.5
...
plat7.position = Vector2( (65+platOffX)*64, 25*64 )
plat7.layer = 0.5
