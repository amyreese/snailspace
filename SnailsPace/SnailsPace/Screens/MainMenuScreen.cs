...
namespace A_Snail_s_Pace.Screens
{
    class MainMenuScreen : InputReadyScreen
    {
        ...
        protected void initializeSprites()
        {
            ...
            sprites[0] = new Graphics.TestGraphics.TextureTestSprite(snailsPace.Content, new Vector2(8, 8), new Vector2(4, 4), 0.01f);
        }
        ...
        protected override void initializeKeyMappings()
        {
            ...
            assignKeyToAction(new KeyCombination(Keys.Escape),
                            new ActionMapping(new ActionMapping.KeyAction(snailsPace.exitGame),
                            ActionMapping.Perform.OnKeyDown));

            // Start The Game
            assignKeyToAction(new KeyCombination(Keys.Space),
                            new ActionMapping(new ActionMapping.KeyAction(snailsPace.startGame),
                            ActionMapping.Perform.OnKeyDown));
